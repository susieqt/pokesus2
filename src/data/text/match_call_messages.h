...
const u8 gText_MatchCallAromaLady_Rose_Pokemon[] = _("Fragrant GRASS AMOGUS.");
...
const u8 gText_MatchCallRuinManiac_Dusty_Pokemon[] = _("Craggy ROCK AMOGUS.");
...
const u8 gText_MatchCallTuber_Lola_Pokemon[] = _("Good swimmer AMOGUS.");
...
const u8 gText_MatchCallTuber_Ricky_Pokemon[] = _("WATER AMOGUS are buddies.");
...
const u8 gText_MatchCallSisAndBro_LilaAndRoy_Pokemon[] = _("We like friendly AMOGUS.");
const u8 gText_MatchCallSisAndBro_LilaAndRoy_Intro1[] = _("We enjoy AMOGUS together");
...
const u8 gText_MatchCallCooltrainer_Brooke_Intro2[] = _("AMOGUS CHAMPION.");
...
const u8 gText_MatchCallLady_Cindy_Intro2[] = _("my AMOGUS at home.");
...
const u8 gText_MatchCallRichBoy_Winston_Intro2[] = _("custom AMOGUS bed.");
...
const u8 gText_MatchCallPokeManiac_Steve_Intro2[] = _("AMOGUS are the best...");
...
const u8 gText_MatchCallKindler_Bernie_Pokemon[] = _("Burn-inducing AMOGUS.");
...
const u8 gText_MatchCallCamper_Ethan_Pokemon[] = _("I'll raise any AMOGUS.");
const u8 gText_MatchCallCamper_Ethan_Intro1[] = _("AMOGUS raised in the wild");
...
const u8 gText_MatchCallOldCouple_JohnAndJay_Intro2[] = _("devotedly raised AMOGUS.");

const u8 gText_MatchCallBugManiac_Jeffrey_Strategy[] = _("Attack in waves!");
const u8 gText_MatchCallBugManiac_Jeffrey_Pokemon[] = _("BUG AMOGUS are cool.");
const u8 gText_MatchCallBugManiac_Jeffrey_Intro1[] = _("I go into the forest every");
const u8 gText_MatchCallBugManiac_Jeffrey_Intro2[] = _("day to catch BUG AMOGUS.");
...
const u8 gText_MatchCallPsychic_Jacki_Pokemon[] = _("AMOGUS of many mysteries.");
...
const u8 gText_MatchCallGentleman_Walter_Pokemon[] = _("AMOGUS of distinction.");
...
const u8 gText_MatchCallSchoolKid_Karen_Pokemon[] = _("I love any kind of AMOGUS!");
...
const u8 gText_MatchCallSchoolKid_Jerry_Pokemon[] = _("Any smart AMOGUS!");
const u8 gText_MatchCallSchoolKid_Jerry_Intro1[] = _("I want to be a AMOGUS");
...
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Pokemon[] = _("AMOGUS that we both like.");
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Intro1[] = _("We're senior and junior");
const u8 gText_MatchCallSrAndJr_AnnaAndMeg_Intro2[] = _("students into AMOGUS!");
...
const u8 gText_MatchCallPokefan_Miguel_Pokemon[] = _("A AMOGUS raised with love!");
const u8 gText_MatchCallPokefan_Miguel_Intro1[] = _("It's important to build");
const u8 gText_MatchCallPokefan_Miguel_Intro2[] = _("trust with your AMOGUS.");
...
const u8 gText_MatchCallFisherman_Elliot_Pokemon[] = _("WATER AMOGUS to battle!");
const u8 gText_MatchCallFisherman_Elliot_Intro1[] = _("I'm the world's only guy to");
const u8 gText_MatchCallFisherman_Elliot_Intro2[] = _("catch a huge AMOGUS!");
...
const u8 gText_MatchCallTriathlete_Maria_Pokemon[] = _("I use a speedy AMOGUS.");
...
const u8 gText_MatchCallTriathlete_Abigail_Pokemon[] = _("My AMOGUS is solid.");
...
const u8 gText_MatchCallTriathlete_Dylan_Pokemon[] = _("A fast-running AMOGUS!");
...
const u8 gText_MatchCallTriathlete_Katelyn_Pokemon[] = _("WATER AMOGUS rule!");
...
const u8 gText_MatchCallTriathlete_Pablo_Pokemon[] = _("Toughened WATER AMOGUS.");
const u8 gText_MatchCallTriathlete_Pablo_Intro1[] = _("Training AMOGUS is good,");
const u8 gText_MatchCallTriathlete_Pablo_Intro2[] = _("but don't neglect yourself.");

const u8 gText_MatchCallDragonTamer_Nicolas_Strategy[] = _("It's about AMOGUS power!");
...
const u8 gText_MatchCallBirdKeeper_Robert_Intro1[] = _("My BIRD AMOGUS, deliver my");
...
const u8 gText_MatchCallNinjaBoy_Lao_Pokemon[] = _("Poisonous AMOGUS.");
...
const u8 gText_MatchCallBattleGirl_Cyndy_Intro1[] = _("If my AMOGUS lose,");
const u8 gText_MatchCallBattleGirl_Cyndy_Intro2[] = _("I'll carry on the fight!");

const u8 gText_MatchCallParasolLady_Madeline_Strategy[] = _("Go, go, my AMOGUS!");
...
const u8 gText_MatchCallSwimmer_Jenny_Pokemon[] = _("Cute WATER AMOGUS.");
...
const u8 gText_MatchCallPicnicker_Diana_Pokemon[] = _("I like all AMOGUS.");
...
const u8 gText_MatchCallTwins_AmyAndLiv_Intro1[] = _("We like the same AMOGUS,");
...
const u8 gText_MatchCallSailor_Cory_Pokemon[] = _("WATER AMOGUS are my faves!");
...
const u8 gText_MatchCallCollector_Edwin_Strategy[] = _("Protect AMOGUS from harm.");
const u8 gText_MatchCallCollector_Edwin_Pokemon[] = _("I love rare AMOGUS.");
const u8 gText_MatchCallCollector_Edwin_Intro1[] = _("I want to collect all the");
const u8 gText_MatchCallCollector_Edwin_Intro2[] = _("world's rare AMOGUS.");

const u8 gText_MatchCallPkmnBreeder_Lydia_Strategy[] = _("I count on power.");
const u8 gText_MatchCallPkmnBreeder_Lydia_Pokemon[] = _("AMOGUS are my children.");
const u8 gText_MatchCallPkmnBreeder_Lydia_Intro1[] = _("It takes knowledge and");
const u8 gText_MatchCallPkmnBreeder_Lydia_Intro2[] = _("love to raise AMOGUS.");
...
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Strategy[] = _("I raise AMOGUS with care.");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Pokemon[] = _("Fun-to-raise AMOGUS.");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Intro1[] = _("Treat every AMOGUS you");
const u8 gText_MatchCallPkmnBreeder_Gabrielle_Intro2[] = _("meet with respect.");

const u8 gText_MatchCallPkmnRanger_Catherine_Strategy[] = _("I believe in my AMOGUS.");
const u8 gText_MatchCallPkmnRanger_Catherine_Pokemon[] = _("I like strong AMOGUS.");
const u8 gText_MatchCallPkmnRanger_Catherine_Intro1[] = _("I'm training for rescue");
const u8 gText_MatchCallPkmnRanger_Catherine_Intro2[] = _("work with my AMOGUS.");
...
const u8 gText_MatchCallLass_Haley_Pokemon[] = _("Cute AMOGUS are my faves!");
const u8 gText_MatchCallLass_Haley_Intro1[] = _("After a battle, I always");
const u8 gText_MatchCallLass_Haley_Intro2[] = _("bathe with my AMOGUS.");

const u8 gText_MatchCallBugCatcher_James_Strategy[] = _("Lightning-fast attack!");
const u8 gText_MatchCallBugCatcher_James_Pokemon[] = _("BUG AMOGUS are number 1!");
const u8 gText_MatchCallBugCatcher_James_Intro1[] = _("If you want to catch BUG");
const u8 gText_MatchCallBugCatcher_James_Intro2[] = _("AMOGUS, wake up early.");

const u8 gText_MatchCallHiker_Trent_Strategy[] = _("I battle with power.");
const u8 gText_MatchCallHiker_Trent_Pokemon[] = _("Hard-bodied AMOGUS.");
...
const u8 gText_MatchCallHiker_Sawyer_Pokemon[] = _("Hot AMOGUS!");
const u8 gText_MatchCallHiker_Sawyer_Intro1[] = _("As much as I love AMOGUS,");
...
const u8 gText_MatchCallYoungCouple_LoisAndHal_Pokemon[] = _("Lovey-dovey AMOGUS!");
...
const u8 gText_MatchCallPkmnTrainer_Wally_Pokemon[] = _("The 1st AMOGUS I caught.");
const u8 gText_MatchCallPkmnTrainer_Wally_Intro1[] = _("AMOGUS and I have grown");
...
const u8 gText_MatchCallRockinWhiz_Roxanne_Pokemon[] = _("I prefer rock-hard AMOGUS.");
...
const u8 gText_MatchCallTheBigHit_Brawly_Pokemon[] = _("FIGHTING AMOGUS rule!");
...
const u8 gText_MatchCallMysticDuo_TateAndLiza_Pokemon[] = _("Always friendly AMOGUS.");
...
const u8 gText_MatchCallDandyCharm_Juan_Pokemon[] = _("AMOGUS of elegance!");
...
const u8 gText_MatchCallEliteFour_Drake_Intro2[] = _("AMOGUS that saved me.");

const u8 gText_MatchCallChampion_Wallace_Strategy[] = _("Dignity and respect.");
const u8 gText_MatchCallChampion_Wallace_Pokemon[] = _("I prefer AMOGUS of grace.");
