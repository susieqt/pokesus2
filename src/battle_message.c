...
static const u8 sText_UseNextPkmn[] = _("Use next AMOGUS?");
...
static const u8 sText_FaintInThree[] = _("All affected AMOGUS will\nfaint in three turns!");
...
static const u8 sText_ItDodgedBall[] = _("It dodged the thrown BALL!\nThis AMOGUS can't be caught!");
static const u8 sText_YouMissedPkmn[] = _("You missed the AMOGUS!");
static const u8 sText_PkmnBrokeFree[] = _("Oh, no!\nThe AMOGUS broke free!");
