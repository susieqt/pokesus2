...
static const u8 gCreditsText_PkmnEmeraldVersion[] = _("AMOGUS EMERALD VERSION");
...
static const u8 gCreditsText_PkmnDesigners[] = _("AMOGUS Designers");
static const u8 gCreditsText_MusicComposition[] = _("Music Composition");
static const u8 gCreditsText_SoundEffectsAndPkmnVoices[] = _("Sound Effects & AMOGUS Voices");
...
static const u8 gCreditsText_PokedexText[] = _("SUSDEX Text");
