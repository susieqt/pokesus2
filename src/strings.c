...
const u8 gText_ExpandedPlaceholder_Kyogre[] = _("AMONGDRIP");
const u8 gText_ExpandedPlaceholder_Groudon[] = _("AMONGDRIP");
...
const u8 gText_BerryPickingRecords[] = _("AMOGUS BERRY-PICKING RECORDS");
