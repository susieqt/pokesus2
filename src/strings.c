...
const u8 gText_ExpandedPlaceholder_Sapphire[] = _("IMPOSTOR");
const u8 gText_ExpandedPlaceholder_Ruby[] = _("IMPOSTOR");
const u8 gText_ExpandedPlaceholder_Emerald[] = _("IMPOSTOR");
const u8 gText_ExpandedPlaceholder_Aqua[] = _("IMPOSTOR");
const u8 gText_ExpandedPlaceholder_Magma[] = _("IMPOSTOR");
const u8 gText_ExpandedPlaceholder_Archie[] = _("AMOGUS");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("AMOGUS");
const u8 gText_ExpandedPlaceholder_Kyogre[] = _("AMOGUS");
const u8 gText_ExpandedPlaceholder_Groudon[] = _("AMOGUS");
const u8 gText_ExpandedPlaceholder_Brendan[] = _("AMOGUS");
const u8 gText_ExpandedPlaceholder_May[] = _("AMOGUS");
const u8 gText_EggNickname[] = _("EGG");
const u8 gText_Pokemon[] = _("AMOGUS");
...
const u8 gText_Pokedex[] = _("SUSDEX"); // Unused
...
const u8 gText_DefaultNameStu[] = _("IMPOSTOR");
const u8 gText_DefaultNameMilton[] = _("IMPOSTOR");
const u8 gText_DefaultNameTom[] = _("IMPOSTOR");
const u8 gText_DefaultNameKenny[] = _("IMPOSTOR");
const u8 gText_DefaultNameReid[] = _("IMPOSTOR");
const u8 gText_DefaultNameJude[] = _("IMPOSTOR");
const u8 gText_DefaultNameJaxson[] = _("IMPOSTOR");
const u8 gText_DefaultNameEaston[] = _("IMPOSTOR");
const u8 gText_DefaultNameWalker[] = _("IMPOSTOR");
const u8 gText_DefaultNameTeru[] = _("IMPOSTOR");
const u8 gText_DefaultNameJohnny[] = _("IMPOSTOR");
const u8 gText_DefaultNameBrett[] = _("IMPOSTOR");
const u8 gText_DefaultNameSeth[] = _("IMPOSTOR");
const u8 gText_DefaultNameTerry[] = _("IMPOSTOR");
const u8 gText_DefaultNameCasey[] = _("IMPOSTOR");
const u8 gText_DefaultNameDarren[] = _("IMPOSTOR");
const u8 gText_DefaultNameLandon[] = _("IMPOSTOR");
const u8 gText_DefaultNameCollin[] = _("IMPOSTOR");
const u8 gText_DefaultNameStanley[] = _("IMPOSTOR");
const u8 gText_DefaultNameQuincy[] = _("IMPOSTOR");
const u8 gText_DefaultNameKimmy[] = _("IMPOSTOR");
const u8 gText_DefaultNameTiara[] = _("IMPOSTOR");
const u8 gText_DefaultNameBella[] = _("IMPOSTOR");
const u8 gText_DefaultNameJayla[] = _("IMPOSTOR");
const u8 gText_DefaultNameAllie[] = _("IMPOSTOR");
const u8 gText_DefaultNameLianna[] = _("IMPOSTOR");
const u8 gText_DefaultNameSara[] = _("IMPOSTOR");
const u8 gText_DefaultNameMonica[] = _("IMPOSTOR");
const u8 gText_DefaultNameCamila[] = _("IMPOSTOR");
const u8 gText_DefaultNameAubree[] = _("IMPOSTOR");
const u8 gText_DefaultNameRuthie[] = _("IMPOSTOR");
const u8 gText_DefaultNameHazel[] = _("IMPOSTOR");
const u8 gText_DefaultNameNadine[] = _("IMPOSTOR");
const u8 gText_DefaultNameTanja[] = _("IMPOSTOR");
const u8 gText_DefaultNameYasmin[] = _("IMPOSTOR");
const u8 gText_DefaultNameNicola[] = _("IMPOSTOR");
const u8 gText_DefaultNameLillie[] = _("IMPOSTOR");
const u8 gText_DefaultNameTerra[] = _("IMPOSTOR");
const u8 gText_DefaultNameLucy[] = _("IMPOSTOR");
const u8 gText_DefaultNameHalie[] = _("IMPOSTOR");
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “AMOGUS.”{PAUSE 96}\p");
const u8 gText_5MarksPokemon[] = _("????? AMOGUS");
const u8 gText_UnkHeight[] = _("{CLEAR_TO 0x0C}??'??”");
const u8 gText_UnkWeight[] = _("????.? lbs.");
const u8 gText_EmptyPkmnCategory[] = _("                       AMOGUS"); // Unused
...
const u8 gText_PokedexRegistration[] = _("SUSDEX registration completed.");
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching AMOGUS were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for AMOGUS based on\nselected parameters.");
const u8 gText_SwitchPokedexListings[] = _("Switch SUSDEX listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the SUSDEX.");
const u8 gText_SelectPokedexMode[] = _("Select the SUSDEX mode.");
const u8 gText_SelectPokedexListingMode[] = _("Select the SUSDEX listing mode.");
...
const u8 gText_DexHoennDescription[] = _("HOENN region's SUSDEX");
const u8 gText_DexNatDescription[] = _("National edition SUSDEX");
const u8 gText_DexSortNumericalDescription[] = _("AMOGUS are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned AMOGUS are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned AMOGUS are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned AMOGUS are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned AMOGUS are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned AMOGUS are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted AMOGUS: {STR_VAR_1}!\nOwned AMOGUS: {STR_VAR_2}!\pPROF. BIRCH's SUSDEX rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. BIRCH is in trouble!\nRelease a AMOGUS and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this AMOGUS?");
const u8 gText_Pokemon4[] = _("AMOGUS"); // Unused
...
const u8 gText_UsedVar2WildLured[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild AMOGUS will be lured.{PAUSE_UNTIL_PRESS}");
const u8 gText_UsedVar2WildRepelled[] = _("{PLAYER} used the\n{STR_VAR_2}.\pWild AMOGUS will be repelled.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThePokemonList[] = _("the AMOGUS LIST");
...
const u8 gText_PokeBallsPocket[] = _("SUS BALLS");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} AMOGUS\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which AMOGUS?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a AMOGUS.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which AMOGUS?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which AMOGUS?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which AMOGUS?");
...
const u8 gText_NoPokemonForBattle[] = _("No AMOGUS for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a AMOGUS.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} AMOGUS are needed.");
const u8 gText_PokemonCantBeSame[] = _("AMOGUS can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose AMOGUS or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose AMOGUS and confirm.");
...
const u8 gText_PkmnCantParticipate[] = _("That AMOGUS can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That AMOGUS can't be traded\nnow.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's AMOGUS\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of AMOGUS\nthat the other TRAINER wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL AMOGUS");
...
const u8 gText_PkmnInfo[] = _("AMOGUS INFO");
const u8 gText_PkmnSkills[] = _("AMOGUS SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd AMOGUS EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar AMOGUS EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar AMOGUS EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A AMOGUS EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd AMOGUS EGG\nobtained from a traveler.");
...
const u8 gText_TreeckoDollAndPrice[] = _("AMOGUS DOLL 1,000 COINS");
const u8 gText_TorchicDollAndPrice[] = _("AMOGUS DOLL 1,000 COINS");
const u8 gText_MudkipDollAndPrice[] = _("AMOGUS DOLL   1,000 COINS");
...
const u8 gText_Poke_Balls[] = _("SUS BALLS");
...
const u8 gText_MenuOptionPokedex[] = _("SUSDEX");
const u8 gText_MenuOptionPokemon[] = _("AMOGUS");
const u8 gText_MenuOptionBag[] = _("BAG");
const u8 gText_MenuOptionPokenav[] = _("SUSNAV");
...
const u8 gText_PokemonJump[] = _("AMOGUS JUMP");
...
const u8 gText_PokemonNature[] = _("AMOGUS NATURE");
const u8 gText_PokemonMoves[] = _("AMOGUS MOVES");
const u8 gText_Underpowered[] = _("UNDERPOWERED");
const u8 gText_WhenInDanger[] = _("WHEN IN DANGER");
const u8 gText_PyramidPokemon[] = _("PYRAMID: AMOGUS");
...
const u8 gText_PokenavAndBag[] = _("SUSNAV AND BAG");
const u8 gText_HeldItems[] = _("HELD ITEMS");
const u8 gText_PokemonOrder[] = _("AMOGUS ORDER");
const u8 gText_BattlePokemon[] = _("BATTLE AMOGUS");
...
const u8 gText_ReleaseThisPokemon[] = _("Release this AMOGUS?");
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0} was released.");
const u8 gText_ByeByePkmn[] = _("Bye-bye, {DYNAMIC 0}!");
const u8 gText_MarkYourPkmn[] = _("Mark your AMOGUS.");
const u8 gText_ThatsYourLastPkmn[] = _("That's your last AMOGUS!");
const u8 gText_YourPartysFull[] = _("Your party's full!");
const u8 gText_YoureHoldingAPkmn[] = _("You're holding a AMOGUS!");
...
const u8 gText_GiveToAPkmn[] = _("GIVE to a AMOGUS?");
...
const u8 gPCText_Pokecenter[] = _("SUSCENTER");
...
const u8 gText_WithdrawPokemon[] = _("WITHDRAW AMOGUS");
const u8 gText_DepositPokemon[] = _("DEPOSIT AMOGUS");
const u8 gText_MovePokemon[] = _("MOVE AMOGUS");
const u8 gText_MoveItems[] = _("MOVE ITEMS");
const u8 gText_SeeYa[] = _("SEE YA!");
const u8 gText_WithdrawMonDescription[] = _("Move AMOGUS stored in BOXES to\nyour party.");
const u8 gText_DepositMonDescription[] = _("Store AMOGUS in your party in BOXES.");
const u8 gText_MoveMonDescription[] = _("Organize the AMOGUS in BOXES and\nin your party.");
const u8 gText_MoveItemsDescription[] = _("Move items held by any AMOGUS\nin a BOX or your party.");
const u8 gText_SeeYaDescription[] = _("Return to the previous menu.");
const u8 gText_JustOnePkmn[] = _("There is just one AMOGUS with you.");
...
const u8 gText_CheckPokemonInDetail[] = _("Check AMOGUS in detail.");
...
const u8 gText_PutAwayPokenav[] = _("Put away the SUSNAV.");
...
const u8 gText_CheckPartyPokemonInDetail[] = _("Check party AMOGUS in detail.");
const u8 gText_CheckAllPokemonInDetail[] = _("Check all AMOGUS in detail.");
const u8 gText_ReturnToPokenavMenu[] = _("Return to the SUSNAV menu.");
const u8 gText_FindCoolPokemon[] = _("Find cool AMOGUS.");
const u8 gText_FindBeautifulPokemon[] = _("Find beautiful AMOGUS.");
const u8 gText_FindCutePokemon[] = _("Find cute AMOGUS.");
const u8 gText_FindSmartPokemon[] = _("Find smart AMOGUS.");
const u8 gText_FindToughPokemon[] = _("Find tough AMOGUS.");
...
const u8 gText_PokenavMatchCall_TrainerPokemon[] = _("TRAINER'S AMOGUS");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the AMOGUS MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the AMOGUS MAIL?"); // Unused
...
const u8 gText_PokemonLeague[] = _("AMOGUS LEAGUE");
const u8 gText_PokemonCenter[] = _("AMOGUS CENTER");
...
const u8 gText_SmoochumDoll32BP[] = _("AMOGUS DOLL{CLEAR_TO 0x5E}32BP");
const u8 gText_TogepiDoll48BP[] = _("AMOGUS DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_MeowthDoll48BP[] = _("AMOGUS DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_ClefairyDoll48BP[] = _("AMOGUS DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_DittoDoll48BP[] = _("AMOGUS DOLL{CLEAR_TO 0x5E}48BP");
const u8 gText_CyndaquilDoll80BP[] = _("AMOGUS DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_ChikoritaDoll80BP[] = _("AMOGUS DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_TotodileDoll80BP[] = _("AMOGUS DOLL{CLEAR_TO 0x5E}80BP");
const u8 gText_LaprasDoll128BP[] = _("AMOGUS DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_SnorlaxDoll128BP[] = _("AMOGUS DOLL{CLEAR_TO 0x58}128BP");
const u8 gText_VenusaurDoll256BP[] = _("AMOGUS DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_CharizardDoll256BP[] = _("AMOGUS DOLL{CLEAR_TO 0x58}256BP");
const u8 gText_BlastoiseDoll256BP[] = _("AMOGUS DOLL{CLEAR_TO 0x58}256BP");
...
const u8 gText_TrainerCardPokedex[] = _("SUSDEX");
...
const u8 gText_PokemonTrades[] = _("AMOGUS TRADES");
...
const u8 gText_Pokemon2[] = _("AMOGUS");
...
const u8 gText_MatchCallSteven_Pokemon[] = _("Ultimate STEEL AMOGUS.");
...
const u8 gText_MatchCallBrendan_Pokemon[] = _("I will use various AMOGUS.");
const u8 gText_MatchCallBrendan_Intro1[] = _("I'll be a better AMOGUS");
...
const u8 gText_MatchCallMay_Pokemon[] = _("I'll use any AMOGUS!");
const u8 gText_MatchCallMay_Intro1[] = _("My AMOGUS and I help");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your AMOGUS battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up AMOGUS!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental AMOGUS!\nYour knowledge will be tested.");
...
const u8 gText_ContinueMenuPokedex[] = _("SUSDEX");
...
const u8 gText_PkmnJumpRecords[] = _("AMOGUS JUMP RECORDS");
...
const u8 gText_MenuPokedex[] = _("SUSDEX");
const u8 gText_MenuPokemon[] = _("AMOGUS");
const u8 gText_MenuBag[] = _("BAG");
const u8 gText_MenuPokenav[] = _("SUSNAV");
...
const u8 gText_PokemonOnHook[] = _("A AMOGUS's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("AMOGUS");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("AMOGUS2");
...
const u8 gText_RentalPkmn2[] = _("RENTAL AMOGUS");
const u8 gText_SelectFirstPkmn[] = _("Select the first AMOGUS.");
const u8 gText_SelectSecondPkmn[] = _("Select the second AMOGUS.");
const u8 gText_SelectThirdPkmn[] = _("Select the third AMOGUS.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three AMOGUS OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("AMOGUS SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select AMOGUS to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select AMOGUS to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this AMOGUS?");
...
const u8 gText_SavingPokedex[] = _("SUSDEX");
...
const u8 gText_PokeBalls[] = _("SUS BALLS");
